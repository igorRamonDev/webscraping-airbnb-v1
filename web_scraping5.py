# url5 ="https://www.airbnb.com.br/s/Araruama-~-RJ/homes?flexible_trip_lengths%5B%5D=one_week&query=Araruama%20-%20RJ&place_id=ChIJ-6YPcGBplwARPMyE_X9my94&refinement_paths%5B%5D=%2Fhomes&tab_id=home_tab&date_picker_type=calendar&source=structured_search_input_header&search_type=autocomplete_click"
from bs4 import BeautifulSoup
import requests


class WebScraping5:
    def __init__(self, url5):
        self.url5 = url5
        self.soup = self.get_html()

    def get_html(self):
        req = requests.get(self.url5)
